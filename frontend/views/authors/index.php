...
<div class="page-shop-sidebar left--sidebar bg--white section-padding--lg">
    <div class="container">
        <div class="row">
            <?php include($_SERVER['DOCUMENT_ROOT'].'/frontend/views/books/left.php'); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="shop__list__wrapper d-flex flex-wrap flex-md-nowrap justify-content-between">
                            ...
                            <?php $countity = sizeof($authors); ?>
                            <p><?= $countity ?> ta natijadan, 1 dan – <?= $countity <= 12 ? $countity : 12 ?> gacha
                                ko`rsatilmoqda </p>
                        </div>
                    </div>
                                ...
                                <?php foreach ($authors as $author): ?>
                                    ...
                                    <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="product__thumb">
                                            <a class="first__img"
                                               href="<?= Url::toRoute(['authors/view', 'id' => $author->id]) ?>"><img
                                                        src="<?= $author->getImage(); ?>" alt="product image"></a>
                                                ...
                                                <div class="actions_inner">
                                                    <ul class="add_to_links">
                                                        <li><a class="cart" title="O`qish"
                                                               href="<?= Url::toRoute(['books/view', 'id' => $book1->id]) ?>"><i
                                                                        class="bi bi-article"></i></a></li>
                                                        <!--                                                        <li><a class="cart" title="Ko`chirib olish" href="-->
                                                        <? //= $author->getDoc();?><!--"><i class="fa fa-download"></i></a></li>-->
                            ...
                            <div class="list__view__wrapper">
                                <?php foreach ($authors as $author): ?>
                                    ...
                                    <div class="list__view">
                                        <div class="thumb">
                                            <a class="first__img"
                                               href="<?= Url::toRoute(['books/view', 'id' => $author->id]) ?>"><img
                                                        src="<?= $author->getImage(); ?>" alt="product images"></a>
                                        </div>
                                        <div class="content">
                                            <h2>
